...
text:function(a){return a.i18n("buttons.copy","Копировать")},action:function(a,b,e,c){var a=C(b,c),d=a.str,e=g("<div/>").css({height:1,width:1,overflow:"hidden",position:"fixed",top:0,left:0});c.customize&&(d=c.customize(d,c));c=g("<textarea readonly/>").val(d).appendTo(e);if(f.queryCommandSupported("copy")){e.appendTo(b.table().container());c[0].focus();c[0].select();try{f.execCommand("copy");e.remove();b.buttons.info(b.i18n("buttons.copyTitle","Копировать"),b.i18n("buttons.copySuccess",{1:"Скопирована одна строка в буффер",
_:"Скопировано %d строк в буффер"},a.rows),2E3);return}catch(i){}}a=g("<span>"+b.i18n("buttons.copyKeys","Нажми <i>ctrl</i> или <i>âŒ˜</i> + <i>C</i> для копирования таблицы<br>в буффер.<br><br>Для отмены, нажмите по этому окну.")+"</span>").append(e);b.buttons.info(b.i18n("buttons.copyTitle","Копировать в буффер обмена"),a,0);c[0].focus();c[0].select();var h=g(a).closest(".dt-button-info"),m=function(){h.off("click.buttons-copy");g(f).off(".buttons-copy");b.buttons.info(!1)};h.on("click.buttons-copy",
