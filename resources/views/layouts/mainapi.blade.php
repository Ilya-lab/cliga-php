...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('api/css/app.css').'?v='.config('app.version') }}">
    <noscript>
        <link rel="stylesheet" href="{{ asset('api/css/ce_bundle.css.css').'?v='.config('app.version') }}">
    </noscript>
    <link rel="shortcut icon" href="{{ asset('api/images/favicon.png').'?v='.config('app.version') }}">
    <link rel="apple-touch-icon" href="{{ asset('api/images/touchicon-180.png').'?v='.config('app.version') }}">
    <link rel="canonical" href="{{url()->current()}}">
    <title>@yield('title') &nbsp;|&nbsp; API доступа &nbsp;|&nbsp; Разработчикам</title>

    <meta property="og:title" content="@yield('title') &nbsp;|&nbsp; API доступа &nbsp;|&nbsp; Разработчикам">
            ...
            <div class="devsite-book-nav-wrapper">
                <div class="devsite-mobile-nav-bottom">
                    <ul class="devsite-nav-list" menu="_book">
                        <li class="devsite-nav-item"><a href="{{ route('api_doc') }}" class="devsite-nav-title"><span class="devsite-nav-text" tooltip>Введение</span></a></li>
                        <li class="devsite-nav-item">
                            <a href="{{ route('api_doc_sports') }}" class="devsite-nav-title">
                                <span class="devsite-nav-text" tooltip>Виды спорта</span>
                            </a>
                        </li>
                        <li class="devsite-nav-item">
                            <a href="{{ route('api_doc_leagues') }}" class="devsite-nav-title">
                        ...
                        <li class="devsite-nav-item devsite-nav-expandable"><devsite-expandable-nav collapsed>
                                ...
                                <ul class="devsite-nav-section">
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_seasons') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Обзор</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_seasons_league') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Сезоны в лиге</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_seasons_all') }}" class="devsite-nav-title">
                        ...
                        <li class="devsite-nav-item devsite-nav-expandable"><devsite-expandable-nav collapsed>
                                ...
                                <ul class="devsite-nav-section">
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments') }}" class="devsite-nav-title">
                                        <span class="devsite-nav-text" tooltip>Обзор</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_all') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Все соревнования</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_season_sport') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Соревнования по виду спорта и сезону</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_teams') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Команды - участники</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_stages') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Этапы (стадии)</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_struct') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Структура</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_seasons_league') }}" class="devsite-nav-title">
                                    ...
                                    <li class="devsite-nav-item devsite-nav-expandable"><devsite-expandable-nav collapsed>
                                            ...
                                            <ul class="devsite-nav-section">
                                                <li class="devsite-nav-item">
                                                    <a href="{{ route('api_doc_matches') }}" class="devsite-nav-title">
                                                        <span class="devsite-nav-text" tooltip>Обзор</span>
                                                    </a>
                                                </li>
                                                <li class="devsite-nav-item">
                                                    <a href="{{ route('api_doc_matches_lastfirst') }}" class="devsite-nav-title">
                                    ...
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_table') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Турнирная таблица</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="{{ route('api_doc_tournaments_place') }}" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Призёры</span>
                                        </a>
                                    </li>
                                </ul>
                            </devsite-expandable-nav>
            ...
            <devsite-content>
                <article class="devsite-article">
                    <article class="devsite-article-inner">
                        ...
                        <h1 class="devsite-page-title">@yield('header')</h1>
                        <section id="overview">
                            @yield('content')
                        </section>
