...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('noqbot-webdesign/noqbot-bootstrap.min.css').'?v='.config('app.version') }}">
    <link rel="stylesheet" href="{{ asset('noqbot-webdesign/noqbot-cancel.min.css').'?v='.config('app.version') }}">
    <link rel="stylesheet" href="{{ asset('noqbot-webdesign/noqbot-jquery.css').'?v='.config('app.version') }}">
    <link rel="stylesheet" href="{{ asset('noqbot-webdesign/noqbot-base.css').'?v='.config('app.version') }}">
    <link rel="stylesheet" href="{{ asset('noqbot-webdesign/noqbot-responsive.css').'?v='.config('app.version') }}">
    ...
    <meta itemprop="og:headline" content="@yield('title')" />
    <meta itemprop="og:description" content="@yield('desc')" />
    <!-- <script>
        var slideIndex = 1;
                                ...
                                <div id="noqbot-addnavigationm-mobile" class="noqbot-addnavigationm-mobile collapse navbar-collapse">
                                    <div class="noqbot-colhalf pull-right">
                                        <nav class="noqbot-addnav">
                                            <ul>
                                                @foreach(InterfaceModule::menu() as $menu)
                        ...
                        <nav id="noqbot-nav" class="noqbot-nav brand-center">
                            <div class="navbar-header">
                                ...
                                <strong class="noqbot-logo">
                                    <a href="{{ url('/') }}"><img src="{{ asset('images/logo.png') }}" alt="image description"></a>
                                </strong>
                            </div>
                    ...
                    <div class="col-sm-3 col-xs-12">
                        ...
                        <div class="wrapper-icons-top">
                            <ul>
                                ...
                                <li class="facebook"><a href="{{ route('redirect',['youtube']) }}"><i class="fa fa-youtube-play fa-2x" aria-hidden="true"></i></a></li>
								<li class="vkontakte"><a href="https://vk.com/corliga"><i class="fa fa-vk fa-2x" aria-hidden="true"></i></a></li>
                                <li class="instagram"><a href="{{ route('redirect',['instagram']) }}"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a></li>
                                <li class="whatsapp"><a href="{{ route('redirect',['whatsapp']) }}"><i class="fa fa-whatsapp fa-2x" aria-hidden="true"></i></a></li>
                    ...
                    <div id="myCarousel" class="row carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            @foreach($games as $match)
                                @if($loop->index % 6 == 0)
                                    <div class="item @if($currentM == 0) @for($i=$loop->index; $i<count($games); $i++) @if($i==$loop->index+6) @break; @endif @if($games[$i]->status_id < 2 && $currentM == 0)active@php $currentM = $i;@endphp @break @endif @endfor @endif">
                                        <ul class="thumbnails">
                                            @endif
                                            <li id="noqbot-name-team-result-block" class="col-sm-2">
                                                <div class="caption-box">
                                                    <p class="noqbot-info-result"><i id="noqbot-news-clock-icon" class="fa fa-info-circle"></i>{{ $match->mainstage->tournament->sport->name }}. {{ $match->mainstage->tournament->name }}. @if($match->status_id == 1)<a href="{{ route('tournament_match',[$match->mainstage->tournament->url, $match->id ]) }}"><img height="20" src="{{ asset('/images/live.png') }}" width="40"></a>@endif</p>
                                                    <p class="noqbot-time-result"><i id="noqbot-news-clock-icon" class="fa fa-clock-o"></i>{{ $match->tour->shortname.' - '.date('d.m.y H:i', strtotime($match->datetime)) }}</p>
                                                    <div id="noqbot-name-team-result-home" class="col-sm-12">
                                                        <div id="noqbot-name-team" class="col-sm-10">
                                                            <h3 class="noqbot-name-team-result-home">@if($match->home){{ $match->home->name }}@else {{ $match->homename }} @endif</h3>
                                                        </div>
                                                        <div id="noqbot-name-result" class="col-sm-2">
                                                            <h3 class="noqbot-score-team-result-home">@if($match->status_id > 0){{ $match->homescore }}@endif</h3>
                                                        </div>
                                                    </div>
                                                    <div id="noqbot-name-team-result-away" class="col-sm-12">
                                                        <div id="noqbot-name-team" class="col-sm-10">
                                                            <h3 class="noqbot-name-team-result-away">@if($match->away){{ $match->away->name }}@else {{ $match->awayname }} @endif</h3>
                                                        </div>
                                                        <div id="noqbot-name-result" class="col-sm-2">
                                                            <h3 class="noqbot-score-team-result-away">@if($match->status_id > 0){{ $match->awayscore }}@endif</h3>
                                                        </div>
            ...
            <nav id="menu" class="nav">
                <ul>
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/amfr_new.png') }}" alt="image description">
								</span>
                    ...
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/fbm_new.png') }}" alt="image description">
								</span>
                    ...
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/rs_new.png') }}" alt="image description">
								</span>
                            <span>Россвязь</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/smr_new.png') }}" alt="image description">
								</span>
                    ...
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/arb_new.png') }}" alt="image description">
								</span>
                    ...
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/br_new.png') }}" alt="image description">
								</span>
                    ...
                    <li>
                        <a href="#">
								<span class="icon">
									<img src="{{ asset('images/partners/mlbl_new.png') }}" alt="image description">
								</span>
                            ...
                            <div class="noqbot-footercol">
                                ...
                                <div class="noqbot-stratum">
                                    <div class="wrapper-icons-footer">
                                        <ul>
                                            <li class="facebook"><a href="{{ route('redirect',['youtube']) }}"><i class="fa fa-youtube-play fa-2x" aria-hidden="true"></i></a></li>
                                            <li class="twitter"><a href="{{ route('redirect',['vk']) }}"><i class="fa fa-vk fa-2x" aria-hidden="true"></i></a></li>
                                            <li class="instagram"><a href="{{ route('redirect',['instagram']) }}"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a></li>
                                            <li class="whatsapp"><a href="{{ route('redirect',['whatsapp']) }}"><i class="fa fa-whatsapp fa-2x" aria-hidden="true"></i></a></li>
                                            <li class="google"><a href="javascript().html" data-toggle="modal" data-target="#noqbot-feedback"><i class="fa fa-envelope fa-2x" aria-hidden="true"></i></a></li>
                                        </ul>
