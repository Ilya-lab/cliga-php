...
@section('header')Описание для работы с API @endsection
@section('menu')
...
@section('content')
    ...
    <table class="responsive properties" id="property-table">
        ...
        <tbody>
        <tr>
            <td><a href="{{ route('api_doc_tournaments') }}"><code itemprop="property" translate="no" dir="ltr">tournaments</code></a></td>
            <td>Все зарегистрированные соревнования</td>
        </tr>
        <tr>
            <td><a href="{{ route('api_doc_sports') }}"><code itemprop="property" translate="no" dir="ltr">sports</code></a></td>
            <td>Виды спорта</td>
        </tr>
        <tr>
            <td><a href="{{ route('api_doc_leagues') }}"><code itemprop="property" translate="no" dir="ltr">leagues</code></a></td>
            <td>Лиги</td>
        </tr>
        </tbody>
    </table>
