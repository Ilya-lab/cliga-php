...
@section('title')Соревнования. Метод lastfirst. @endsection
@section('header')Метод lastfirst @endsection
@section('menu')
...
[{
    ...
    <table class="responsive properties" id="property-table">
        ...
        <tr id="championat_id">
            ...
            <td><code class="apitype notranslate" dir="ltr"><span>unsigned integer</span></code><br>
                Уникальный идентификатор <code translate="no" dir="ltr"><span>соревнования</span></code> (см. <a href="{{ route('api_doc_tournaments_all').'#id' }}">свойста соревнования</a>).</td>
        </tr>
        <tr id="championat">
