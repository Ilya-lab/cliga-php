...
@section('js')<script type="text/javascript" src="{{ asset('js/jqwidgets/jqxcore.js').'?v='.config('app.version') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/jqwidgets/jqxwindow.js').'?v='.config('app.version') }}"></script>
    ...
    <script src="{{ asset('js/translite.js').'?v='.config('app.version') }}"></script>
    <script src="{{ asset('js/other.js').'?v='.config('app.version') }}"></script>
    <script src="{{ asset('js/tinymce/tinymce.min.js').'?v='.config('app.version') }}"></script>
...
@endsection
@section('css')<link rel="stylesheet" href="{{ asset('js/jqwidgets/styles/jqx.base.css').'?v='.config('app.version') }}" type="text/css" />
...
@section('js_footer')
    <script type="text/javascript" src="{{ asset('resources/home/players.js').'?v='.config('app.version') }}"></script>
@endsection

@section('content')
    @component('components.main_block')
        @slot('title')Участники @endslot
        @slot('description')Участники соревнований @endslot
        <button type="button" class="btn btn-primary player-add" data-toggle="modal" data-target=".bs-modal">Добавить участника</button>
        <div class="ln_solid"></div>
        <div id="grid" data-load-route="{{ route('person_ajaxload') }}" data-save-route="{{ route('person_save') }}" data-show-route="{{ url('/home/person/') }}" data-update-route="{{ url('/home/person/') }}"></div>
