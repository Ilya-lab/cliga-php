...
@section('desc')Новость Корпоративной лиги: {{ $news->title }}@endsection
								...
								<div class="noqbot-postdetail">
									...
									<div class="noqbot-widget noqbot-tags-widget">
										...
										<div class="noqbot-social-share pull-right">
											...
											<ul>
												<li class="facebook"><a href="{{ route('redirect',['youtube']) }}"><i data-iconname="Перейти в YouTube" class="fa fa-youtube-play fa-2x" aria-hidden="true"></i></a></li>
												<li class="twitter"><a href="{{ route('redirect',['vk']) }}"><i data-iconname="Перейти вКонтакт" class="fa fa-vk fa-2x" aria-hidden="true"></i></a></li>
												<li class="instagram"><a href="{{ route('redirect',['instagram']) }}"><i data-iconname="Перейти в Instgram" class="fa fa-instagram fa-2x" aria-hidden="true"></i></a></li>
												<li class="whatsapp"><a href="{{ route('redirect',['whatsapp']) }}"><i data-iconname="Перейти в WhatsApp" class="fa fa-whatsapp fa-2x" aria-hidden="true"></i></a></li>
