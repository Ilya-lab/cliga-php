            ...
            <div class="modal-body">
                <form class="form-horizontal form-label-left">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div id="techMatch">
                                <button style="padding:4px 16px;" id="homeTech"><?php if( $match->home): ?><?php echo e($match->home->name); ?><?php else: ?> хозяевам <?php endif; ?></button>
                                <button style="padding:4px 16px;" id="awayTech"><?php if( $match->away): ?><?php echo e($match->away->name); ?><?php else: ?> гостям <?php endif; ?></button>
                            </div>
                        </div>
                    </div>
                </form>
...
<input id="level_id" type="hidden" value="<?php echo e($match->mainstage->levels_id); ?>">
...
<script type="text/javascript" src="<?php echo e(asset('js/jqwidgets/jqxbuttongroup.js').'?v='.config('app.version')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/jqwidgets/jqxradiobutton.js').'?v='.config('app.version')); ?>"></script>
<script>
    $('#dialog').modal('toggle')

    $('#stateMatch').jqxSwitchButton({ height: 27, width: 160,  checked: true, onLabel:'ЗАВЕРШЁН', offLabel: 'ИДЁТ' })
    $('#homeScore').jqxNumberInput({ value: <?php echo e($match->homescore == null ? 0 : $match->homescore); ?>, width: 70, height: '35px', spinButtons: true, digits: 2,
        inputMode: 'simple', decimalDigits: 0, min: 0, max: 100, spinButtonsWidth: 30, textAlign: 'center', theme: 'bootstrap' })
    $('#awayScore').jqxNumberInput({ value: <?php echo e($match->awayscore == null ? 0 : $match->awayscore); ?>, width: 70, height: '35px', spinButtons: true, digits: 2,
        inputMode: 'simple', decimalDigits: 0, min: 0, max: 100, spinButtonsWidth: 30, textAlign: 'center', theme: 'bootstrap' })
    $('#viewerMatch').jqxNumberInput({ value: <?php echo e($match->viewers == null ? 0 : $match->viewers); ?>, width: 100, height: '35px', spinButtons: true, digits: 6,
