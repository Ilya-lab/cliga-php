<?php $__env->startSection('title'); ?>Соревнования. Метод all. <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('menu'); ?>
    <?php echo $__env->make('api.block_menu',['menu' => [
                                                                    ...
                                                                    array('name' => 'Метод all', 'url' => route('api_doc_tournaments_all')),
]                                                                ], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <p>Метод <code translate="no" dir="ltr">all</code> ресурса <code translate="no" dir="ltr">tournaments</code> возвращает все зарегистрированные соревнования.
        <a href="<?php echo e(route('api_tournaments',1)); ?>">Выполнить</a>.</p>

    <devsite-heading text="Запрос" for="properties_1" level="h4" link="" toc=""><h4 is-upgraded="" id="properties_1">Запрос</h4></devsite-heading>
    <pre id="alt-json" class="notranslate" style="max-height: 500px; overflow: auto" dir="ltr" is-upgraded=""><?php echo e(route('api_tournaments',1)); ?></pre>
