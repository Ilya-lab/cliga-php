...
<?php $__env->startSection('content'); ?>
    ...
    <dt class="notranslate"><a href="<?php echo e(route('api_doc_tournaments_stages')); ?>">stages</a></dt>
    <dd>Возвращает этапы соревнования.
        <a href="<?php echo e(route('api_tournaments_stages',1)); ?>">Выполнить</a>.</dd>
    <dt class="notranslate"><a href="<?php echo e(route('api_doc_tournaments_struct')); ?>">struct</a></dt>
    <dd>Возвращает этапы соревнования.
        <a href="<?php echo e(route('api_tournaments_struct',1)); ?>">Выполнить</a>.</dd>
    <dt class="notranslate"><a href="<?php echo e(route('api_doc_tournaments_table')); ?>">struct/{struct_id}/table</a></dt>
    <dd>Возвращает турнирную таблицу этапа соревнования.
        <a href="<?php echo e(route('api_tournaments_table',[403,30])); ?>">Выполнить</a>.</dd>
    <dt class="notranslate"><a href="<?php echo e(route('api_doc_tournaments_place')); ?>">place</a></dt>
    <dd>Возвращает призёров завершившегося турнира.
        <a href="<?php echo e(route('api_tournaments_place',400)); ?>">Выполнить</a>.</dd>
<?php $__env->stopSection(); ?>
