    ...
    <?php $__env->startComponent('components.main_block'); ?>
        ...
        <?php if($roles->contains(1)): ?>
            <?php $__env->startComponent('components.small_block'); ?>
                ...
                <?php $__env->slot('url'); ?><?php echo e(route('admin_showdisq', $tournament->id)); ?> <?php $__env->endSlot(); ?>
        ...
        <?php if($roles->contains(1)): ?>
            <?php $__env->startComponent('components.small_block'); ?>
                ...
                <?php $__env->slot('url'); ?><?php echo e(route('admin_settings', $tournament->id)); ?> <?php $__env->endSlot(); ?>
