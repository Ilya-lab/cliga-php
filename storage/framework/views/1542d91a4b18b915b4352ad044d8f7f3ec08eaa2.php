<?php $__env->startSection('title'); ?>Лиги. <?php $__env->stopSection(); ?>
<?php $__env->startSection('header'); ?>Лиги <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <p>Возвращает все лиги. Данный ресурс необходим если Корпоративная лига является не единственной в системе статистики.
        <a href="<?php echo e(route('api_leagues')); ?>">Выполнить</a>.</p>

    <devsite-heading text="Запрос" for="properties_1" level="h4" link="" toc=""><h4 is-upgraded="" id="properties_1">Запрос</h4></devsite-heading>
    <pre id="alt-json" class="notranslate" style="max-height: 500px; overflow: auto" dir="ltr" is-upgraded=""><?php echo e(route('api_leagues')); ?></pre>
