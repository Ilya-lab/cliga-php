            ...
            if(response['status'] === 'fail') {
                ...
                if(gg) {
                    ...
                    gg.find('td').each(function(cell){
                        //console.log('ячейка ' + cell + ', значение: ' + $(this).html())
                        if(cell == 0) $(this).html(response['match']['number'])
                        else if(cell == 1) $(this).html('<small>'+response['match']['datetime']+'</small>')
                        else if(cell == 2) $(this).html(response['match']['place']['field']['arena']['name']+' ('+response['match']['place']['field']['number']+')')
                        else if(cell == 3) $(this).html(response['match']['home']['name'])
                        else if(cell == 5) $(this).html(response['match']['away']['name'])
                    })
                }
                console.log(gg)
