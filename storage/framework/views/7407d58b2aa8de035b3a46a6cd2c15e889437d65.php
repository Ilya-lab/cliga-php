...
<?php $__env->startSection('content'); ?>
                                ...
                                <table class="next-match-table">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" scope="row" class="time-td team-sign">
                                                <a href="<?php echo e(route('tournament_match', [$match->championat_url, $match->match_id])); ?>" style="color: #ffffff;" target="_blank"><?php if($match->status_id > 0): ?> <?php echo e($match->home_score.'-'.$match->away_score); ?> <?php else: ?> -<?php endif; ?></a>
                                        </td>
    ...
    <iframe src="<?php echo e(route('widgets_tournaments')); ?>" id="iframe-standings" width="100%" height="650" frameBorder="0"></iframe>
