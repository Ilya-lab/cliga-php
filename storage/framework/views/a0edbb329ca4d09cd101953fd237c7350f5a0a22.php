                    ...
                    <ul class="devsite-nav-list" menu="_book">
                        ...
                        <li class="devsite-nav-item devsite-nav-expandable"><devsite-expandable-nav collapsed>
                                ...
                                <ul class="devsite-nav-section">
                                    ...
                                    <li class="devsite-nav-item">
                                        <a href="<?php echo e(route('api_doc_tournaments_stages')); ?>" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Этапы (стадии)</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="<?php echo e(route('api_doc_tournaments_struct')); ?>" class="devsite-nav-title">
                                    ...
                                    <li class="devsite-nav-item">
                                        <a href="<?php echo e(route('api_doc_tournaments_table')); ?>" class="devsite-nav-title">
                                            <span class="devsite-nav-text" tooltip>Турнирная таблица</span>
                                        </a>
                                    </li>
                                    <li class="devsite-nav-item">
                                        <a href="<?php echo e(route('api_doc_tournaments_place')); ?>" class="devsite-nav-title">
