    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($team->id); ?>"><?php echo e($team->name); ?> <?php if($team->city != ""): ?> (<?php echo e($team->city); ?>) <?php endif; ?></option>
            ...
            <div class="modal-footer">
                <button id="saveAdd" type="button" class="btn btn-success" data-id="<?php echo e($tourn_id); ?>">Добавить</button>
...
<script>
    ...
    $('#saveAdd').on('click', function () {
        ...
        $.ajax({
            ...
            url: '<?php echo e(route('admin_tournadddisqplayer')); ?>',
            data: {tourn_id: <?php echo e($tourn_id); ?>, match_id: $('#match').val(), player_id: $('#player').val(),
                matches: $('#matches').val(), type_id: 3, comments: $('#comment').val() },
            ...
            if(response['status'] === 'fail') {
                ...
                if(gg) {
                    gg.append('<tr class="border-top data-id="'+response['disq']['id']+'">\n' +
                        '                        <td class="text-center p-2"></td>\n' +
                        '                        <td class="text-left disqview" <?php if(!$closed): ?>  style="cursor: pointer;" <?php endif; ?>>'+response['disq']['family']+' '+response['disq']['name']+'</td>\n' +
                        ...
                        '                        <td class="text-left"><small class="ml-2 hidden-xs">'+response['disq']['comment']+'</small></td>\n' +
    ...
    $('#match').on('change', function (event)
    {
        var args = event.args
        if (args) {
            var uurl = '<?php echo e(route('api_tournament_match_players', [ '###', '!!!'])); ?>'
    ...
    function loadGames(team) {
        var uurl = '<?php echo e(route('api_tournament_team_matches', [$tourn_id, '###'])); ?>'
