...
<?php $__env->startSection('content'); ?>
    <p>Метод <code translate="no" dir="ltr">table</code> ресурса <code translate="no" dir="ltr">tournaments</code> этапа ресурса <code translate="no" dir="ltr">stage</code> возвращает турнирную таблицу этапа соревнования. Данный метод работает только для стадий (этапов) с идентификатором 3 или 4. В противном случае возвращается пустой массив.
