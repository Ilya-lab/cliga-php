    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="modal-body window-scrollable">
                        ...
                        <table class="w-100">
                            ...
                            <?php $__currentLoopData = $matches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $match): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center"><small><?php if($match->datetime): ?><?php echo e(date('d.m.y   H:i', strtotime($match->datetime))); ?><?php endif; ?></small></td>
                                    <td class="text-right"><?php echo e($match->home_team); ?></td>
                                    <td class="text-center"> - </td>
                                    <td class="text-left"><?php echo e($match->away_team); ?></td>
                                    <td class="pt-3"><input class="player-mode" type="checkbox" name="game[<?php echo e($match->id); ?>]" match_id="<?php echo e($match->id); ?>" <?php if($disqMatches->contains('id', $match->id)): ?> checked <?php endif; ?> disabled /></td>
                                </tr>
            ...
            <div class="modal-footer">
                <button id="saveEdit" type="button" class="btn btn-success hidden" data-id="<?php echo e($player->id); ?>">Сохранить</button>
...
<script>
    ...
    $('#saveEdit').on('click', function () {
        ...
        $.ajax({
            ...
            url: '<?php echo e(route('admin_tourndisqplayerchange')); ?>',
