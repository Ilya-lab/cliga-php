<?php $__env->startSection('title'); ?>Сезоны. Метод league. <?php $__env->stopSection(); ?>
<?php $__env->startSection('header'); ?>Метод league <?php $__env->stopSection(); ?>
<?php $__env->startSection('menu'); ?>
    <?php echo $__env->make('api.block_menu',['menu' => [
                                                                    array('name' => 'Сезоны', 'url' => route('api_doc_seasons')),
                                                                    array('name' => 'Метод league', 'url' => route('api_doc_seasons_league')),
]                                                                ], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <p>Метод <code translate="no" dir="ltr">league</code> ресурса <code translate="no" dir="ltr">seasons</code> возвращает все сезоны в лиге, с идентификатором <code translate="no" dir="ltr">id</code>. См.описание <a href="<?php echo e(route('api_doc_leagues')); ?>">лиги</a>.
        <a href="<?php echo e(route('api_seasons_leagues', 1)); ?>">Выполнить</a>.</p>

    <devsite-heading text="Запрос" for="properties_1" level="h4" link="" toc=""><h4 is-upgraded="" id="properties_1">Запрос</h4></devsite-heading>
    <pre id="alt-json" class="notranslate" style="max-height: 500px; overflow: auto" dir="ltr" is-upgraded=""><?php echo e(route('api_seasons_leagues', 1)); ?></pre>
    <p>Запрос выполняется с парметром идентификатора лиги <code translate="no" dir="ltr">id</code>.</p>
