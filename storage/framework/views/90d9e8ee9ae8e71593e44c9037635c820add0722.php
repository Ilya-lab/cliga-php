        ...
        <div id='tabNextMatch'>
            ...
            <div class="m-3">
                <table class="w-100" id="table-<?php echo e($stage->id); ?>">
                    ...
                    <?php endif; ?>
                    <tr class="popoverable border-top <?php if($loop->index % 2 == 0 && $game->status_id == 0): ?> bg-light <?php endif; ?> <?php if($game->status_id == 1): ?> bg-blue-sky <?php endif; ?>" data-match-id="<?php echo e($game->id); ?>" data-match-status="<?php echo e($game->status_id); ?>">
