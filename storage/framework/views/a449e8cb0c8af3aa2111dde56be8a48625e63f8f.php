<?php $__env->startSection('title'); ?>Соревнования. Метод teams. <?php $__env->stopSection(); ?>
<?php $__env->startSection('header'); ?>Метод teams <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <p>Метод <code translate="no" dir="ltr">teams</code> ресурса <code translate="no" dir="ltr">tournaments</code> возвращает все заявленные на турнир команды.
        <a href="<?php echo e(route('api_tournaments_teams',1)); ?>">Выполнить</a>.</p>

    <devsite-heading text="Запрос" for="properties_1" level="h4" link="" toc=""><h4 is-upgraded="" id="properties_1">Запрос</h4></devsite-heading>
    <pre id="alt-json" class="notranslate" style="max-height: 500px; overflow: auto" dir="ltr" is-upgraded=""><?php echo e(route('api_tournaments_teams',1)); ?></pre>
