<?php $__env->startSection('title'); ?>Соревнования. Метод sport season. <?php $__env->stopSection(); ?>
<?php $__env->startSection('header'); ?>Метод sport season <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <p>Метод <code translate="no" dir="ltr">all</code> ресурса <code translate="no" dir="ltr">tournaments</code> возвращает соревнования за лигу по виду спорта и сезон.
        <a href="<?php echo e(route('api_tournaments_seasonsport',[1,0,1])); ?>">Выполнить</a>.</p>

    <devsite-heading text="Запрос" for="properties_1" level="h4" link="" toc=""><h4 is-upgraded="" id="properties_1">Запрос</h4></devsite-heading>
    <pre id="alt-json" class="notranslate" style="max-height: 500px; overflow: auto" dir="ltr" is-upgraded=""><?php echo e(route('api_tournaments_seasonsport',[1,0,1])); ?></pre>
    <ul>Запрос выполняется с параметрами:
        <li><code translate="no" dir="ltr">league_id</code> - идентификатор <a href="<?php echo e(route('api_doc_leagues')); ?>">лиги</a>;
        <li><code translate="no" dir="ltr">sport_id</code> - идентификатор <a href="<?php echo e(route('api_doc_sports')); ?>">вида спорта</a>;
        <li><code translate="no" dir="ltr">season_id</code> - идентификатор <a href="<?php echo e(route('api_doc_seasons')); ?>">сезона</a>.
    </ul>
