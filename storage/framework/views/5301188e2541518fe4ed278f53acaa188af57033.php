<?php $__env->startSection('title'); ?>Соревнования. Метод struct. <?php $__env->stopSection(); ?>
<?php $__env->startSection('header'); ?>Метод struct <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <p>Метод <code translate="no" dir="ltr">struct</code> ресурса <code translate="no" dir="ltr">tournaments</code> возвращает структуру турнира в древовидной форме с турнирными таблицами.
        <a href="<?php echo e(route('api_tournaments_stages',1)); ?>">Выполнить</a>.</p>

    <devsite-heading text="Запрос" for="properties_1" level="h4" link="" toc=""><h4 is-upgraded="" id="properties_1">Запрос</h4></devsite-heading>
    <pre id="alt-json" class="notranslate" style="max-height: 500px; overflow: auto" dir="ltr" is-upgraded=""><?php echo e(route('api_tournaments_struct',1)); ?></pre>
    <ul>Запрос выполняется с параметрами:
        <li><code translate="no" dir="ltr">tournament_id</code> - идентификатор <a href="<?php echo e(route('api_doc_tournaments')); ?>">соревнования</a>.
    </ul>
